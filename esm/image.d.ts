 ...
 * ```
*/
export declare const trimImagePadding: <Channels extends 1 | 3 | 2 | 4>(img_data: SimpleImageData, padding_condition: PaddingCondition[Channels], minimum_non_padding_value?: number) => SimpleImageData;
