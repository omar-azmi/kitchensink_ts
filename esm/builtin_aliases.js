...
min: math_min, max: math_max, sign: math_sign, abs: math_abs, 
// numeric rounding functions
round: math_round, ceil: math_ceil, floor: math_floor, trunc: math_trunc, fround: math_fround, 
// triginometric functions
sin: math_sin, cos: math_cos, tan: math_tan, asin: math_asin, acos: math_acos, atan: math_atan, sinh: math_sinh, cosh: math_cosh, tanh: math_tanh, asinh: math_asinh, acosh: math_acosh, atanh: math_atanh, atan2: math_atan2, 
// math functions
cbrt: math_cbrt, clz32: math_clz32, exp: math_exp, expm1: math_expm1, hypot: math_hypot, imul: math_imul, log: math_log, log10: math_log10, log1p: math_log1p, log2: math_log2, pow: math_pow, sqrt: math_sqrt, 
// random function
random: math_random, 
// math constants
...
export const { EPSILON: number_EPSILON, MAX_SAFE_INTEGER: number_MAX_SAFE_INTEGER, MAX_VALUE: number_MAX_VALUE, MIN_SAFE_INTEGER: number_MIN_SAFE_INTEGER, MIN_VALUE: number_MIN_VALUE, NEGATIVE_INFINITY: number_NEGATIVE_INFINITY, NaN: number_NaN, POSITIVE_INFINITY: number_POSITIVE_INFINITY, isFinite: number_isFinite, isInteger: number_isInteger, isNaN: number_isNaN, isSafeInteger: number_isSafeInteger, parseFloat: number_parseFloat, parseInt: number_parseInt, } = Number;
export const { asIntN: bigint_asIntN, asUintN: bigint_asUintN, } = BigInt;
export const { fromCharCode: string_fromCharCode, fromCodePoint: string_fromCodePoint, raw: string_raw, } = String;
export const { parse: json_parse, stringify: json_stringify, } = JSON;
export const { all: promise_all, allSettled: promise_allSettled, any: promise_any, race: promise_race, reject: promise_reject, resolve: promise_resolve, } = Promise;
